...
export default async function Products() {
 const serveces=  dbconnection(CollectionNameobj.ServicesCollection) 
  ...
  return (
    <div>
        ...
        {data.map((items)=>{
            return (
                <div className='lg:col-span-4  md:col-span-6 col-span-12' key={items.id}>
  ...
  <div className="card-body">
    ...
    <p className='text-black '>{items.description.slice(0,100)}</p>
